const textZone:HTMLElement = document.querySelector('#textZone');
...
const listWrap:HTMLElement = document.querySelector('#listWrap');
const list1:HTMLElement = document.querySelector('.list1');
...
const hover:HTMLElement = document.querySelector('.hover');
